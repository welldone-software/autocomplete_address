...
export const cityStreetData = {
  ...
  מוקייבלה: ['מוקייבלה'],
  מורן: ['אלה', 'אלון', 'אלקלעה', 'גפן', 'זית', 'מורן', 'רימון', 'תאנה', 'תמר'],
  מורשת: [
    'אריאל',
    'בית אל',
    'השילוח',
  ...
  צביה: ['דרך הקשת', 'האלה', 'האלון', 'הטל', 'הכליל', 'השחר', 'השקד', 'צביה'],
  צבעון: ['צבעון'],
...
export function renderCities(state, val) {
  return state[0].toLowerCase().indexOf(val.toLowerCase()) !== -1;
}
export function renderStreets(state, val) {
  return state.toLowerCase().indexOf(val.toLowerCase()) !== -1;
}
